...
comcode.plot <- function(import_data,
  ...
  labs(title = "Total Weught by Commodity Code",
       subtitle = paste0(
         if (nchar(code) >= 2) {
           import_data[1,paste(Hs2Code, "-", Hs2Description,"\n")]
           } else "",
         if (nchar(code) >= 4) {
           import_data[1,paste(Hs4Code, "-", Hs4Description,"\n")]
           } else "",
         if (nchar(code) >= 6) {
           import_data[1,paste(Hs6Code, "-", Hs6Description,"\n")]
           } else "",
         if (nchar(code) == 8) {
           import_data[1,paste(COMCODE, "-", Cn8LongDescription,"\n")]
           } else ""),
       x = "Year",
       y = "Weight [kg/month]",
...
comcode.plot(imports, "03", lookuptable=Commodity,max_unique_comcodes = 10)
comcode.plot(imports, "0303", lookuptable=Commodity,max_unique_comcodes = 10)
comcode.plot(imports, "01039219", lookuptable=Commodity)
