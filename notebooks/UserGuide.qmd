...
#animals
comcode_plot(imports, "0101", lookup_table=Commodity, max_unique_comcodes = 10)
...
-   *Plot monthly volume, weight and value of imports*

```{r}

comcode_plot_updated <- function(import_data,
                          code,
                          variable,
                          lookup_table,
...
comcode_plot_updated(imports, "01", variable="volume", lookup_table=Commodity, max_unique_comcodes = 10)
comcode_plot_updated(imports, "01", variable="NET_MASS", lookup_table=Commodity, max_unique_comcodes = 10)
comcode_plot_updated(imports, "01", variable="STAT_VALUE", lookup_table=Commodity, max_unique_comcodes = 10)
