...
Note: The above anomaly detection procedures for daily data work but can take a while to run so their output has been excluded in the current version of the html.
